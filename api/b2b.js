...
export default async function handler(req, res) {
  ...
  try {
    ...
    const payload = {
      ...
      AccountReference,
      Remarks,
      QueueTimeOutURL: process.env.B2B_TIMEOUT_URL || "https://www.geniusapps.click/api/callback/stk.js",
      ResultURL: process.env.B2B_RESULT_URL || "https://www.geniusapps.click/api/callback/stk.js"
    };
